                    ...
                    <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border-2 border-primary-200 relative">
                        ...
                        <div className="p-8">
                            ...
                            <div className="text-center mb-8">
                                ...
                                <h2 className="text-2xl sm:text-3xl font-bold text-secondary-600 mb-2">Welcome Back</h2>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-5">
                                ...
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="w-full bg-gradient-to-r from-primary-500 to-primary-600 text-white font-semibold py-3 rounded-lg hover:shadow-lg transition-all disabled:opacity-70 disabled:cursor-not-allowed mt-7 flex items-center justify-center gap-2"
                                >
                                    {loading ? (
                                        <>
